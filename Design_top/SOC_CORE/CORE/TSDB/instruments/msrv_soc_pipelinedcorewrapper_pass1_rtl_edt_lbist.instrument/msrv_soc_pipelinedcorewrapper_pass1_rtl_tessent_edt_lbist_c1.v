...
//          Version: 2026.1
//       Created on: Tue Aug 18 14:31:19 IST 2026
//
//       IP version: 8
//--------------------------------------------------------------------------------
...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_decompressor (
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_sib msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_sib_decompressor_i (
      .ijtag_tck(ijtag_tck),
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_sib msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_sib_lbist_lp_static_control_i (
      .ijtag_tck(ijtag_tck),
      .ijtag_reset(ijtag_reset),
      .ijtag_sel(ijtag_sel),
      .ijtag_ce(ijtag_ce),
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_sib msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_sib_lbist_lp_mask_shift_reg_i (
      .ijtag_tck(ijtag_tck),
      .ijtag_reset(ijtag_reset),
      .ijtag_sel(ijtag_sel),
      .ijtag_ce(ijtag_ce),
...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_onehot_decoder_5_to_30 (
...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_xor_decoder (
...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_controller (
   input  wire        edt_clock,
   input  wire        edt_update,
   input  wire [ 1:0] edt_channels_in,
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_xor_decoder xor_decoder (
      .encoded_masks(xor_encoded_masks),
      .decoded_masks_0(xor_decoded_masks_0),
      .decoded_masks_1(xor_decoded_masks_1));

   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_onehot_decoder_5_to_30 decoder1 (.encoded_masks(onehot_encoded_masks_0),
                                                                                           .decoded_masks(onehot_decoded_masks_0));
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_onehot_decoder_5_to_30 decoder2 (.encoded_masks(onehot_encoded_masks_1),
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_sib msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_sib_i (
      .ijtag_tck(ijtag_tck),
      .ijtag_reset(ijtag_reset),
      .ijtag_sel(ijtag_sel),
      .ijtag_ce(ijtag_ce),
...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_spatial_compactor_30_w_output_lockup (
   input  wire        edt_clock,
...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_compactor (
   input  wire        edt_clock,
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_spatial_compactor_30_w_output_lockup compactor1 (
      .edt_clock(edt_clock),
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_spatial_compactor_30_w_output_lockup compactor2 (
      .edt_clock(edt_clock),
...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_bypass_logic (
...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_misr_reg (
   input  wire        edt_clock,
   input  wire        clear,
   input  wire        scan_en,
   input  wire        scan_in,
...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_misr (
   input  wire        edt_clock,
   input  wire        lbist_reset,
   input  wire        ccm_scan_en,
   input  wire        ccm_le_si,
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_misr_reg msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_misr_reg_i (
      .edt_clock(edt_clock),
      .clear(clear),
...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_lbist_c1 (
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_decompressor msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_decompressor_i (
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_compactor msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_compactor_i (
      .edt_clock(edt_clock_buf_out),
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_controller msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_controller_i (
      .edt_clock(edt_clock_buf_out),
      .edt_update(edt_update_ccm),
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_bypass_logic msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_bypass_logic_i (
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_misr msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_edt_c1_misr_i (
      .edt_clock(edt_clock_buf_out),
      .lbist_reset(lbist_reset),
      .ccm_scan_en(ccm_scan_en),
