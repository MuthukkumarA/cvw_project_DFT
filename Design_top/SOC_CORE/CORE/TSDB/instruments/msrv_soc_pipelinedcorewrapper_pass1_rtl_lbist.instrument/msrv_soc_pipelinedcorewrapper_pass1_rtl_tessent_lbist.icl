...
Module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist { // {{{
    ...
    ClockPort           test_clock {
        ...
        Attribute persistent_pin              = "msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_fsm_i/tessent_persistent_cell_edt_clock_tck_mux/B";
    }
    ClockPort           shift_clock_src {
        Attribute persistent_pin = "msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_fsm_i/tessent_persistent_cell_shift_clock_int_mux/A";
    }
    ToClockPort         lbist_test_clock_out { Source test_clock; }
    ScanInPort          from_edt_scan_out;
    ScanOutPort         to_edt_scan_in      { Source msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_sib_control_registers_i.ijtag_so; }
    ScanInPort          ijtag_si;
    ...
    ToSelectPort        edt_sib_en          { Source msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_edt_sib_i.ijtag_to_sel; }
    ...
    Instance msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_sib_bist_registers_i Of msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_sib {
    ...
    ScanRegister lbist_low_power_shift_en_reg {
        ScanInSource    msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_sib_bist_registers_i.ijtag_so;
        CaptureSource   1'b0;
        ResetValue      1'b0;
    }
    ...
    Instance msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_sib_control_registers_i Of msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_sib {
        InputPort ijtag_reset   = ijtag_reset;
        InputPort ijtag_sel     = ijtag_sel;
        InputPort ijtag_si      = msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_sib_bist_registers_i.ijtag_so;
        InputPort ijtag_ce      = ijtag_ce;
        InputPort ijtag_se      = ijtag_se;
        InputPort ijtag_ue      = ijtag_ue;
        InputPort ijtag_tck     = ijtag_tck;
    ...
    Instance msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_edt_sib_i Of msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_sib {
        InputPort ijtag_reset   = ijtag_reset;
        InputPort ijtag_sel     = ijtag_sel;
        InputPort ijtag_si      = msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_sib_control_registers_i.ijtag_so;
        InputPort ijtag_ce      = ijtag_ce;
        InputPort ijtag_se      = ijtag_se;
        InputPort ijtag_ue      = ijtag_ue;
        InputPort ijtag_tck     = ijtag_tck;
    ...
    ScanRegister ijtag_so_ff {
        ScanInSource    msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_edt_sib_i.ijtag_so;
        CaptureSource   1'b0;
    }
    ...
    Attribute tessent_instrument_container = "msrv_soc_pipelinedcorewrapper_pass1_rtl_lbist.instrument";
