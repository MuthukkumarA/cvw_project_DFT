...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_single_chain_mode_logic (
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_single_chain_mode_logic_sib tdr_sib_i (
      .ijtag_tck(ijtag_tck),
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_single_chain_mode_logic_sib single_chain_sib_i (
      .ijtag_tck(ijtag_tck),
      .ijtag_reset(ijtag_reset),
      .ijtag_sel(ijtag_sel_ccm),
      .ijtag_ce(ijtag_ce_ccm),
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_single_chain_mode_logic_sib blk1_sib_i (
      .ijtag_tck(ijtag_tck),
      .ijtag_reset(ijtag_reset),
