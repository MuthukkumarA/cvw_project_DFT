...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_fsm ( // {{{
   input  wire         ijtag_tck,
   input  wire         ijtag_reset,
   input  wire         ijtag_sel,
   input  wire         ijtag_se,
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_posedge_synchronizer_reset tessent_persistent_cell_lbist_ntc_retiming_cell_lbist_clock_disable (
      .rn                   (ijtag_reset),                      // i
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_clk_inv tessent_persistent_cell_shift_clock_int_inv (
      .a                    (shift_clock_int),                  // i
      .y                    (shift_clock_int_inv)               // o
   );

   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_posedge_synchronizer_reset tessent_persistent_cell_lbist_ntc_retiming_cell_lbist_run_mode (
      .rn                   (ijtag_reset),                      // i
...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_vector_cnt_reg ( // {{{
...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_bit_cnt_reg ( // {{{
   input  wire         lbist_clock,
   input  wire         lbist_reset,
   input  wire         reset,
   input  wire         ccm_scan_en,
...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_counter ( // {{{
   input  wire         lbist_clock,
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_bit_cnt_reg msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_bit_cnt_reg_i (
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_vector_cnt_reg msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_vector_cnt_reg_i (
      .lbist_clock          (lbist_clock),                      // i
      .reset                (reset),                            // i
...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_capture_phase_reg ( // {{{
   input  wire         lbist_clock,
   input  wire         lbist_scan_en,
   input  wire         lbist_reset,
   input  wire         reset,
...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_warmup_pattern_cnt_reg ( // {{{
   input  wire         lbist_clock,
   input  wire         lbist_scan_en,
   input  wire         lbist_reset,
   input  wire         reset,
...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_ctrl_signals ( // {{{
   input  wire         scan_in,
   output wire         scan_out,
   input  wire         ccm_scan_en,
   input  wire         ccm_le_si,
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_sib msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_sib_i (
...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_ctrl ( // {{{
   input  wire         lbist_clock,
   input  wire         lbist_en,
   input  wire         ccm_scan_en,
   input  wire         ccm_le_si,
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_capture_phase_reg msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_capture_phase_size_reg_i (
      .lbist_clock          (lbist_clock),                      // i
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_warmup_pattern_cnt_reg msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_warmup_pattern_cnt_reg_i (
      .lbist_clock          (lbist_clock),                      // i
      .lbist_scan_en        (lbist_scan_en_int),                // i
      .lbist_reset          (lbist_reset),                      // i
      .reset                (ijtag_reset),                      // i
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_counter msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_counter_i (
      .lbist_clock          (lbist_clock),                      // i
      .lbist_scan_en        (lbist_scan_en_int),                // i
...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist ( // {{{
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_ctrl msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_ctrl_i (
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_ctrl_signals msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_ctrl_signals_i (
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_fsm msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_fsm_i (
      .ijtag_tck            (ijtag_tck),                        // i
      .ijtag_reset          (ijtag_reset),                      // i
      .ijtag_sel            (ijtag_sel_ccm),                    // i
      .ijtag_se             (ijtag_se_ccm),                     // i
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_sib msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_lbist_edt_sib_i (
      .ijtag_reset          (ijtag_reset),                      // i
      .ijtag_sel            (ijtag_sel_ccm),                    // i
      .ijtag_ce             (ijtag_ce_ccm),                     // i
      .ijtag_se             (ijtag_se_ccm),                     // i
