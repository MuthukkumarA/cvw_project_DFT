...
Module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_occ {
   ...
   Instance tdr_sib Of msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_occ_sib_int {
   ...
   Attribute tessent_instrument_container = "msrv_soc_pipelinedcorewrapper_pass1_rtl_occ.instrument";
