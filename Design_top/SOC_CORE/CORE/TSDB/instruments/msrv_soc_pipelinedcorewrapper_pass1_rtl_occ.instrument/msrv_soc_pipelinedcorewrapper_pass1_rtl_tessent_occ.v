...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_occ (
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_occ_control occ_control (
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_occ_ijtag_control ijtag_control(
     .ijtag_tck                              ( ijtag_tck                        ),
...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_occ_control (
   input  wire         fast_clock,
   input  wire         slow_clock,
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_posedge_synchronizer_reset tessent_persistent_cell_ltest_ntc_sync_cell (
     .d                                      ( CE_SLOW_CLK                      ),
     .clk                                    ( fast_clock                       ),
   ...
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_occ_shift_reg ShiftReg (
     .clk                                    ( SHIFT_REG_CLK                    ),
     .scan_en                                ( scan_en                          ),
     .capture_cycle_width                    ( capture_cycle_width              ),
...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_occ_ijtag_control (
   input  wire         ijtag_tck,
   input  wire         ijtag_reset,
   input  wire         ijtag_sel,
   input  wire         ijtag_ce,
   ...
   reg    [9:0] tdr;
   reg          tdr_so_retime;
   msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_occ_sib tdr_sib (
     .clock                                  ( ijtag_tck                        ),
     .reset                                  ( ijtag_reset                      ),
     .enable                                 ( ijtag_sel                        ),
     .capture_en                             ( ijtag_ce                         ),
...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_occ_shift_reg (
   input  wire         clk,
   input  wire         scan_en,
   input  wire   [1:0] capture_cycle_width,
...
module msrv_soc_pipelinedcorewrapper_pass1_rtl_tessent_occ_sib (
   input  wire         clock,
   input  wire         reset,
   input  wire         enable,
   input  wire         capture_en,
