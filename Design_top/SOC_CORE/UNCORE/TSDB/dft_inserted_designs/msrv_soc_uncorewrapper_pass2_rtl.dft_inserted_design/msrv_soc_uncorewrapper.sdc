...
#          Version: 2026.1
#       Created on: Tue Aug 18 14:51:33 IST 2026
#--------------------------------------------------------------------------
...
#    tessent_msrv_soc_uncorewrapper_set_dft_signals
#    tessent_get_cells
#    tessent_get_flops
#    tessent_get_pins
#    tessent_get_ports
...
proc tessent_set_default_variables {} {
  ...
  set scan_resource_sib_list [list  \
    msrv_soc_uncorewrapper_pass2_rtl_tessent_sib_edt_inst/to_enable_int* \
    msrv_soc_uncorewrapper_pass2_rtl_tessent_sib_lbist_inst/to_enable_int* \
    msrv_soc_uncorewrapper_pass2_rtl_tessent_sib_occ_inst/to_enable_int* \
    msrv_soc_uncorewrapper_pass2_rtl_tessent_sib_sri_ctrl_inst/to_enable_int* \
    msrv_soc_uncorewrapper_pass2_rtl_tessent_sib_sri_inst/to_enable_int* \
  ]
  ...
  array set tessent_edt_mapping {
    edt_inst0 msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_lbist_c1_inst
  }

  # Use this mapping to find which unique identifier maps to which LBIST controller instance.
  array set tessent_lbist_mapping {
    lbist_inst0 msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_inst
  }
  ...
  array set tessent_lbist_single_chain_mode_logic_mapping {
    lbist_inst0 msrv_soc_uncorewrapper_pass2_rtl_tessent_single_chain_mode_logic_inst
  }
...
proc tessent_set_ltest_set_timing_variables_default {} {  
  ...
  set tessent_edt_channel_out_ports_list {
    ...
    {msrv_soc_uncorewrapper_pass2_rtl_controller_c1_edt_channels_out[1]}
  }
...
proc tessent_set_ltest_non_modal {{logictest on}} {  
  ...
  if {[sizeof_collection $non_scan_clocks]} {
    set_false_path -from $non_scan_clocks -to [tessent_get_cells {
      msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_HCLK_inst/occ_control/scan_out*
      msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_PCLK_inst/occ_control/scan_out*
    }]
    ...
    set_false_path -from $non_scan_clocks -through [tessent_get_pins {
      msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_HCLK_inst/tessent_persistent_cell_scan_in_buf/Z
      msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_PCLK_inst/tessent_persistent_cell_scan_in_buf/Z
    }]
  }
  
  # Mask registers are setup with TCK and static during test
  set_false_path -from [tessent_get_cells $tessent_edt_mapping(edt_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_controller_i/edt_chain_mask*reg*] \
  ...
  set_multicycle_path -setup 8 \
      -from [tessent_get_cells $tessent_lbist_mapping(lbist_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_fsm_i/prpg_en_reg] \
  ...
  set_multicycle_path -hold 7 \
      ...
      -to [remove_from_collection [all_clocks] $tessent_clock_mapping(ts_tck_ijtag_tck)]
  set_multicycle_path -setup 8 \
      -from [tessent_get_cells $tessent_lbist_mapping(lbist_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_fsm_i/misr_en_reg] \
  ...
  set_multicycle_path -setup 3 \
      -from [tessent_get_cells $tessent_lbist_mapping(lbist_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_fsm_i/lbist_reset_reg] \
      -to [remove_from_collection [all_clocks] $tessent_clock_mapping(ts_tck_ijtag_tck)]
  set_multicycle_path -hold 2 \
      -from [tessent_get_cells $tessent_lbist_mapping(lbist_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_fsm_i/lbist_reset_reg] \
      -to [remove_from_collection [all_clocks] $tessent_clock_mapping(ts_tck_ijtag_tck)]
  set_multicycle_path -setup 3 \
      -from [tessent_get_cells $tessent_lbist_mapping(lbist_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_ctrl_signals_i/lbist_sync_reset_reg] \
      -to [remove_from_collection [all_clocks] $tessent_clock_mapping(ts_tck_ijtag_tck)]
  set_multicycle_path -hold 2 \
      -from [tessent_get_cells $tessent_lbist_mapping(lbist_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_ctrl_signals_i/lbist_sync_reset_reg] \
      -to [remove_from_collection [all_clocks] $tessent_clock_mapping(ts_tck_ijtag_tck)]
  ...
  set_disable_timing [tessent_get_pins $tessent_lbist_mapping(lbist_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_fsm_i/tessent_persistent_cell_*_mux/S]
  set_disable_clock_gating_check [tessent_get_cells $tessent_lbist_mapping(lbist_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_fsm_i/tessent_persistent_cell_*_mux]
...
proc tessent_set_ltest_occ {{mode all}} {  
  ...
  set_disable_timing [tessent_get_pins {
    msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_HCLK_inst/tessent_persistent_cell_inject_tck_mux/B
    msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_PCLK_inst/tessent_persistent_cell_inject_tck_mux/B
  }]
  
  # Muxes that switch long before logic test runs
  set_disable_clock_gating_check [tessent_get_cells {
    msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_HCLK_inst/tessent_persistent_cell_inject_tck_mux
    msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_PCLK_inst/tessent_persistent_cell_inject_tck_mux
  }]
  ...
  set mux_coll [tessent_get_cells {
    msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_HCLK_inst/tessent_persistent_cell_clock_out*_mux
    msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_HCLK_inst/occ_control/tessent_persistent_cell_SHIFT_REG_CLK*_mux
    msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_PCLK_inst/tessent_persistent_cell_clock_out*_mux
    msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_PCLK_inst/occ_control/tessent_persistent_cell_SHIFT_REG_CLK*_mux
  }]
...
proc tessent_set_ltest_modal_shift {} {  
  ...
  set_case_analysis 1 [tessent_get_pins msrv_soc_uncorewrapper_pass2_rtl_tessent_tdr_sri_ctrl_inst/tessent_persistent_cell_ltest_en/Z]
  ...
  set_false_path -from [tessent_get_cells $tessent_lbist_mapping(lbist_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_fsm_i/misr_en_reg]
  set_false_path -from [tessent_get_cells $tessent_lbist_mapping(lbist_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_fsm_i/lbist_reset_reg]
  ...
  # LBIST controller clock multiplexers
  set_case_analysis 1            [tessent_get_pins $tessent_lbist_mapping(lbist_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_fsm_i/tessent_persistent_cell_*_mux/S]
  set_disable_clock_gating_check [tessent_get_cells $tessent_lbist_mapping(lbist_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_fsm_i/tessent_persistent_cell_*_mux]
...
proc tessent_set_ltest_modal_edt_fast_capture {} {  
  ...
  set_case_analysis 0 [tessent_get_pins msrv_soc_uncorewrapper_pass2_rtl_tessent_tdr_sri_ctrl_inst/tessent_persistent_cell_control_test_point_en/Z]
  ...
  if {[info exists mcp_bounding_en_value]} {
    set_case_analysis $mcp_bounding_en_value [tessent_get_pins msrv_soc_uncorewrapper_pass2_rtl_tessent_tdr_sri_ctrl_inst/tessent_persistent_cell_mcp_bounding_en/Z]
  }
  global x_bounding_en_value
  if {[info exists x_bounding_en_value]} {
    set_case_analysis $x_bounding_en_value [tessent_get_pins msrv_soc_uncorewrapper_pass2_rtl_tessent_tdr_sri_ctrl_inst/tessent_persistent_cell_x_bounding_en/Z]
  }
  global observe_test_point_en_value
  if {[info exists observe_test_point_en_value]} {
    set_case_analysis $observe_test_point_en_value [tessent_get_pins msrv_soc_uncorewrapper_pass2_rtl_tessent_tdr_sri_ctrl_inst/tessent_persistent_cell_observe_test_point_en/Z]
  }
  global async_set_reset_static_disable_value
  if {[info exists async_set_reset_static_disable_value]} {
    set_case_analysis $async_set_reset_static_disable_value [tessent_get_pins msrv_soc_uncorewrapper_pass2_rtl_tessent_tdr_sri_ctrl_inst/tessent_persistent_cell_async_set_reset_static_disable/Z]
  }
...
proc tessent_set_ltest_modal_edt_slow_capture {} {  
  ...
  tessent_set_ltest_create_clocks 
  # Set input/output delays for ports
  set scan_inports   [remove_from_collection [all_inputs] [tessent_get_ports {test_clock_w HCLK PCLK lbist_shift_clk ijtag_tck ijtag_reset ijtag_ce ijtag_se ijtag_ue ijtag_sel ijtag_si test_clock_w}]]
  ...
  set_false_path -from [tessent_get_cells [list $tessent_lbist_mapping(lbist_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_fsm_i/misr_en_reg]] \
      -to [tessent_get_cells $tessent_edt_mapping(edt_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_misr_i/msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_misr_reg_i/misr*_reg*]
  set_false_path -from [tessent_get_cells [list $tessent_lbist_mapping(lbist_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_fsm_i/lbist_reset_reg]] \
      -to [tessent_get_cells $tessent_edt_mapping(edt_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_misr_i/msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_misr_reg_i/misr*_reg*]
...
proc tessent_set_ltest_disable {{mode all_test_on}} {  
  ...
  tessent_msrv_soc_uncorewrapper_set_dft_signals $mode
  ...
  set_disable_timing             [tessent_get_pins  {msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_HCLK_inst/tessent_persistent_cell_inject_tck_mux/*}]
  set_disable_clock_gating_check [tessent_get_cells {msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_HCLK_inst/tessent_persistent_cell_clock_out*_mux}]
  
  # Prevent tessent_tck from propagating to functional domains and avoid bogus clock gating check warnings.
  set_disable_timing             [tessent_get_pins  {msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_PCLK_inst/tessent_persistent_cell_inject_tck_mux/*}]
  set_disable_clock_gating_check [tessent_get_cells {msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_PCLK_inst/tessent_persistent_cell_clock_out*_mux}]
...
proc tessent_set_ltest_pb_external_mode {} {  
  ...
  set_case_analysis 1 [tessent_get_pins msrv_soc_uncorewrapper_pass2_rtl_tessent_tdr_sri_ctrl_inst/tessent_persistent_cell_ext_ltest_en/Z]
  set_case_analysis 0 [tessent_get_pins msrv_soc_uncorewrapper_pass2_rtl_tessent_tdr_sri_ctrl_inst/tessent_persistent_cell_int_ltest_en/Z]
...
proc tessent_set_ltest_modal_lbist_shift {{clock_select shift_clock_src}} {  
  ...
  set_false_path -from [tessent_get_cells $tessent_lbist_mapping(lbist_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_ctrl_signals_i/lbist_en_reg]
  set_false_path -from [tessent_get_cells $tessent_lbist_mapping(lbist_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_ctrl_signals_i/lbist_setup_reg*]
  set_false_path -from [tessent_get_cells $tessent_lbist_mapping(lbist_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_fsm_i/lbist_run_mode_reg]
  set_false_path -from [tessent_get_cells $tessent_lbist_mapping(lbist_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_ctrl_signals_i/lbist_low_power_shift_en_reg]
  ...
  if {$clock_select in {tck ijtag_tck}} {
    set_case_analysis 0 [tessent_get_pins msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_HCLK_inst/tessent_persistent_cell_inject_tck_mux/S] 
    set_case_analysis 0 [tessent_get_pins msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_PCLK_inst/tessent_persistent_cell_inject_tck_mux/S] 
  }
...
proc tessent_set_ltest_modal_lbist_capture {{clock_select shift_clock_src}} {  
  ...
  set_multicycle_path -hold 1 \
      -from [tessent_get_cells $tessent_lbist_mapping(lbist_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_fsm_i/capture_en_reg]
...
proc tessent_set_ltest_modal_lbist_setup {} {  
  ...
  # LBIST dynamic control signals
  set_false_path -from [tessent_get_cells $tessent_lbist_mapping(lbist_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_fsm_i/prpg_en_reg] \
      -through [tessent_get_pins $tessent_lbist_mapping(lbist_inst0)/tessent_persistent_cell_prpg_en/Z]
  set_false_path -from [tessent_get_cells $tessent_lbist_mapping(lbist_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_fsm_i/misr_en_reg] \
      -through [tessent_get_pins $tessent_lbist_mapping(lbist_inst0)/tessent_persistent_cell_misr_en/Z]
  ...
  # LBIST synchronous reset
  set_false_path -from [tessent_get_cells $tessent_lbist_mapping(lbist_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_fsm_i/lbist_reset_reg]
  set_false_path -from [tessent_get_cells $tessent_lbist_mapping(lbist_inst0)/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_ctrl_signals_i/lbist_sync_reset_reg]
...
proc tessent_get_cts_skew_groups_dict {} {  
  ...
  set return_dict {
    cts_skew_group(occ0) {
      dc_instance      msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_HCLK_inst
    ...
    cts_skew_group(occ1) {
      dc_instance      msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_PCLK_inst
      cts_exclude_pins {occ_control/tessent_persistent_cell_ltest_ntc_sync_cell/clk occ_control/tessent_persistent_cell_cgc_SHIFT_REG_CLK/CK occ_control/tessent_persistent_cell_SHIFT_REG_CLK_mux/B}
    }
  }
  return $return_dict
...
proc tessent_msrv_soc_uncorewrapper_set_dft_signals {{mode reset}} {
#
...
#
  ...
  set_case_analysis 0 [tessent_get_pins msrv_soc_uncorewrapper_pass2_rtl_tessent_tdr_sri_ctrl_inst/tessent_persistent_cell_async_set_reset_static_disable/Z]
  set_case_analysis 0 [tessent_get_pins msrv_soc_uncorewrapper_pass2_rtl_tessent_tdr_sri_ctrl_inst/tessent_persistent_cell_mcp_bounding_en/Z]
  set_case_analysis 0 [tessent_get_pins msrv_soc_uncorewrapper_pass2_rtl_tessent_tdr_sri_ctrl_inst/tessent_persistent_cell_control_test_point_en/Z]
  set_case_analysis 0 [tessent_get_pins msrv_soc_uncorewrapper_pass2_rtl_tessent_tdr_sri_ctrl_inst/tessent_persistent_cell_observe_test_point_en/Z]
  set_case_analysis 0 [tessent_get_pins msrv_soc_uncorewrapper_pass2_rtl_tessent_tdr_sri_ctrl_inst/tessent_persistent_cell_x_bounding_en/Z]
  set_case_analysis 0 [tessent_get_pins msrv_soc_uncorewrapper_pass2_rtl_tessent_tdr_sri_ctrl_inst/tessent_persistent_cell_ext_mode/Z]
  set_case_analysis 0 [tessent_get_pins msrv_soc_uncorewrapper_pass2_rtl_tessent_tdr_sri_ctrl_inst/tessent_persistent_cell_int_mode/Z]
  set_case_analysis 0 [tessent_get_pins msrv_soc_uncorewrapper_pass2_rtl_tessent_tdr_sri_ctrl_inst/tessent_persistent_cell_ext_ltest_en/Z]
  set_case_analysis 0 [tessent_get_pins msrv_soc_uncorewrapper_pass2_rtl_tessent_tdr_sri_ctrl_inst/tessent_persistent_cell_int_ltest_en/Z]
  set_case_analysis 0 [tessent_get_pins msrv_soc_uncorewrapper_pass2_rtl_tessent_tdr_sri_ctrl_inst/tessent_persistent_cell_controller_chain_mode/Z]
  set_case_analysis 0 [tessent_get_pins msrv_soc_uncorewrapper_pass2_rtl_tessent_tdr_sri_ctrl_inst/tessent_persistent_cell_ltest_en/Z]
...
proc tessent_get_optimize_instances {} {
  set optimize_instance_list {
    msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_lbist_c1_inst/msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_bypass_logic_i
    msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_lbist_c1_inst/msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_compactor_i
    msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_lbist_c1_inst/msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_controller_i
    msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_lbist_c1_inst/msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_decompressor_i
    msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_lbist_c1_inst/msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_misr_i
    msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_inst/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_ctrl_i
    msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_inst/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_ctrl_signals_i
    msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_inst/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_edt_sib_i
    msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_inst/msrv_soc_uncorewrapper_pass2_rtl_tessent_lbist_fsm_i
    msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_HCLK_inst/ijtag_control
    msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_HCLK_inst/occ_control
    msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_PCLK_inst/ijtag_control
    msrv_soc_uncorewrapper_pass2_rtl_tessent_occ_PCLK_inst/occ_control
    msrv_soc_uncorewrapper_pass2_rtl_tessent_single_chain_mode_logic_inst/blk1_sib_i
    msrv_soc_uncorewrapper_pass2_rtl_tessent_single_chain_mode_logic_inst/single_chain_sib_i
    msrv_soc_uncorewrapper_pass2_rtl_tessent_single_chain_mode_logic_inst/tdr_sib_i
  }
...
set tessent_old_2_new_proc_name_mapping {
  {tessent_constrain_msrv_soc_uncorewrapper_mentor_ltest_modal_lbist_single_chain tessent_set_ltest_modal_lbist_single_chain no}
  {tessent_constrain_msrv_soc_uncorewrapper_mentor_ltest_modal_lbist_capture tessent_set_ltest_modal_lbist_capture yes}
  {tessent_constrain_msrv_soc_uncorewrapper_mentor_ltest_occ tessent_set_ltest_occ yes}
  {tessent_constrain_msrv_soc_uncorewrapper_mentor_ltest_modal_lbist_shift tessent_set_ltest_modal_lbist_shift yes}
  {tessent_constrain_msrv_soc_uncorewrapper_mentor_ltest_set_timing_variables_default tessent_set_ltest_set_timing_variables_default no}
  {tessent_constrain_msrv_soc_uncorewrapper_non_modal tessent_set_non_modal yes}
  {tessent_constrain_msrv_soc_uncorewrapper_mentor_ltest_modal_lbist_setup tessent_set_ltest_modal_lbist_setup no}
  {tessent_constrain_msrv_soc_uncorewrapper_mentor_ltest_modal_shift tessent_set_ltest_modal_shift no}
  {tessent_constrain_msrv_soc_uncorewrapper_mentor_ltest_disable tessent_set_ltest_disable yes}
  {tessent_constrain_msrv_soc_uncorewrapper_mentor_ltest_modal_edt_shift tessent_set_ltest_modal_edt_shift no}
  {tessent_constrain_msrv_soc_uncorewrapper_mentor_ltest_modal_lbist_controller_chain tessent_set_ltest_modal_lbist_controller_chain no}
  {tessent_constrain_msrv_soc_uncorewrapper_mentor_ltest_core_external_mode tessent_set_ltest_core_external_mode no}
  {tessent_constrain_msrv_soc_uncorewrapper_mentor_ltest_non_modal tessent_set_ltest_non_modal yes}
  {tessent_constrain_msrv_soc_uncorewrapper_mentor_ltest_pb_external_mode tessent_set_ltest_pb_external_mode no}
  {tessent_constrain_msrv_soc_uncorewrapper_mentor_ltest_modal_edt_slow_capture tessent_set_ltest_modal_edt_slow_capture no}
  {tessent_constrain_msrv_soc_uncorewrapper_mentor_ltest_modal_edt_fast_capture tessent_set_ltest_modal_edt_fast_capture no}
  {tessent_constrain_msrv_soc_uncorewrapper_mentor_ijtag_non_modal tessent_set_ijtag_non_modal no}
  {tessent_constrain_msrv_soc_uncorewrapper_mentor_ltest_create_clocks tessent_set_ltest_create_clocks no}
  {tessent_constrain_msrv_soc_uncorewrapper_mentor_ltest_set_pin_delays tessent_set_ltest_set_pin_delays yes}
  {tessent_constrain_msrv_soc_uncorewrapper_mentor_ltest_modal_bypass_shift tessent_set_ltest_modal_bypass_shift no}
}
