...
Module msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_lbist_c1 {
   ...
   Instance msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_sib_decompressor_i Of msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_sib {
   ...
   ScanRegister lbist_lp_hold_reg[3:0] {
      ScanInSource msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_sib_decompressor_i.ijtag_so;
   }
   ...
   Instance msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_sib_lbist_lp_static_control_i Of msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_sib {
      InputPort ijtag_si = msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_sib_decompressor_i.ijtag_so;
      InputPort ijtag_tck = ijtag_tck;
      InputPort ijtag_reset = ijtag_reset;
      InputPort ijtag_sel = ijtag_sel;
      InputPort ijtag_ce = ijtag_ce;
   ...
   ScanRegister lbist_lp_mask_shift_reg[30:0] {
      ScanInSource msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_sib_lbist_lp_static_control_i.ijtag_so;
   }
   Instance msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_sib_lbist_lp_mask_shift_reg_i Of msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_sib {
      InputPort ijtag_si = msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_sib_lbist_lp_static_control_i.ijtag_so;
      InputPort ijtag_tck = ijtag_tck;
      InputPort ijtag_reset = ijtag_reset;
      InputPort ijtag_sel = ijtag_sel;
      InputPort ijtag_ce = ijtag_ce;
   ...
   ScanRegister bist_chain_mask[59:0] {
      ScanInSource msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_sib_lbist_lp_mask_shift_reg_i.ijtag_so;
   }
   ...
   Instance msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_sib_chain_mask_i Of msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_sib {
      InputPort ijtag_si = msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_sib_lbist_lp_mask_shift_reg_i.ijtag_so;
      InputPort ijtag_tck = ijtag_tck;
      InputPort ijtag_reset = ijtag_reset;
      InputPort ijtag_sel = ijtag_sel;
      InputPort ijtag_ce = ijtag_ce;
   ...
   ScanRegister misr_1[31:0] {
      ScanInSource msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_sib_chain_mask_i.ijtag_so;
   }
   ...
   Instance msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_sib_misr_i Of msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_sib {
      InputPort ijtag_si = msrv_soc_uncorewrapper_pass2_rtl_tessent_edt_c1_sib_chain_mask_i.ijtag_so;
      InputPort ijtag_tck = ijtag_tck;
      InputPort ijtag_reset = ijtag_reset;
      InputPort ijtag_sel = ijtag_sel;
      InputPort ijtag_ce = ijtag_ce;
   ...
   Attribute tessent_instrument_container = "msrv_soc_uncorewrapper_pass2_rtl_edt_lbist.instrument";
