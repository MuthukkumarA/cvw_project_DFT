...
module msrv_soc_system_controllerwrapper_sys_controller_tessent_edt_c1_decompressor (
...
module msrv_soc_system_controllerwrapper_sys_controller_tessent_edt_c1_onehot_decoder_5_to_30 (
...
module msrv_soc_system_controllerwrapper_sys_controller_tessent_edt_c1_xor_decoder (
...
module msrv_soc_system_controllerwrapper_sys_controller_tessent_edt_c1_controller (
   input  wire        edt_clock,
   input  wire        edt_update,
   input  wire [ 1:0] edt_channels_in,
   ...
   msrv_soc_system_controllerwrapper_sys_controller_tessent_edt_c1_onehot_decoder_5_to_30 decoder1 (.encoded_masks(onehot_encoded_masks_0),
                                                                                                    .decoded_masks(onehot_decoded_masks_0));
   msrv_soc_system_controllerwrapper_sys_controller_tessent_edt_c1_onehot_decoder_5_to_30 decoder2 (.encoded_masks(onehot_encoded_masks_1),
...
module msrv_soc_system_controllerwrapper_sys_controller_tessent_edt_c1_spatial_compactor_30_w_output_lockup (
   input  wire        edt_clock,
...
module msrv_soc_system_controllerwrapper_sys_controller_tessent_edt_c1_compactor (
   input  wire        edt_clock,
...
module msrv_soc_system_controllerwrapper_sys_controller_tessent_edt_c1_bypass_logic (
...
module msrv_soc_system_controllerwrapper_sys_controller_tessent_edt_c1_misr_reg (
   input  wire        edt_clock,
   input  wire        clear,
   input  wire        scan_en,
   input  wire        scan_in,
...
module msrv_soc_system_controllerwrapper_sys_controller_tessent_edt_c1_misr (
   input  wire        edt_clock,
   input  wire        lbist_reset,
   input  wire        ccm_scan_en,
   input  wire        ccm_le_si,
