...
module msrv_soc_system_controllerwrapper_sys_controller_tessent_lbist_fsm ( // {{{
   input  wire         ijtag_tck,
   input  wire         ijtag_reset,
   input  wire         ijtag_sel,
   input  wire         ijtag_se,
...
module msrv_soc_system_controllerwrapper_sys_controller_tessent_lbist_vector_cnt_reg ( // {{{
...
module msrv_soc_system_controllerwrapper_sys_controller_tessent_lbist_bit_cnt_reg ( // {{{
   input  wire         lbist_clock,
   input  wire         lbist_reset,
   input  wire         reset,
   input  wire         ccm_scan_en,
...
module msrv_soc_system_controllerwrapper_sys_controller_tessent_lbist_counter ( // {{{
   input  wire         lbist_clock,
...
module msrv_soc_system_controllerwrapper_sys_controller_tessent_lbist_capture_phase_reg ( // {{{
   input  wire         lbist_clock,
   input  wire         lbist_scan_en,
   input  wire         lbist_reset,
   input  wire         reset,
...
module msrv_soc_system_controllerwrapper_sys_controller_tessent_lbist_warmup_pattern_cnt_reg ( // {{{
   input  wire         lbist_clock,
   input  wire         lbist_scan_en,
   input  wire         lbist_reset,
   input  wire         reset,
...
module msrv_soc_system_controllerwrapper_sys_controller_tessent_lbist_ctrl_signals ( // {{{
   input  wire         scan_in,
   output wire         scan_out,
   input  wire         ccm_scan_en,
   input  wire         ccm_le_si,
...
module msrv_soc_system_controllerwrapper_sys_controller_tessent_lbist_ctrl ( // {{{
   input  wire         lbist_clock,
   input  wire         lbist_en,
   input  wire         ccm_scan_en,
   input  wire         ccm_le_si,
