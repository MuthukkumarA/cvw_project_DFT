...
Module msrv_soc_system_controllerwrapper_sys_controller_tessent_single_chain_mode_logic { // {{{
    ...
    Instance tdr_sib_i Of msrv_soc_system_controllerwrapper_sys_controller_tessent_single_chain_mode_logic_sib {
    ...
    Instance msrv_soc_system_controllerwrapper_sys_controller_tessent_edt_internal_scan_registers_i Of msrv_soc_system_controllerwrapper_sys_controller_tessent_edt_internal_scan_registers {
    ...
    Instance single_chain_sib_i Of msrv_soc_system_controllerwrapper_sys_controller_tessent_single_chain_mode_logic_sib {
        InputPort ijtag_tck     = ijtag_tck;
        InputPort ijtag_si      = tdr_sib_i.ijtag_so;
        InputPort ijtag_reset   = ijtag_reset;
        InputPort ijtag_sel     = ijtag_sel;
        ...
        InputPort ijtag_se      = ijtag_se;
        InputPort ijtag_ue      = ijtag_ue;
        InputPort ijtag_from_so = msrv_soc_system_controllerwrapper_sys_controller_tessent_edt_internal_scan_registers_i.ijtag_so;
    }
...
Module msrv_soc_system_controllerwrapper_sys_controller_tessent_edt_internal_scan_registers {
   ScanInPort ijtag_si;
   ...
   Instance blk1_sib_i Of msrv_soc_system_controllerwrapper_sys_controller_tessent_single_chain_mode_logic_sib {
      InputPort ijtag_tck = ijtag_tck;
      InputPort ijtag_reset = ijtag_reset;
      InputPort ijtag_si = ijtag_si;
      InputPort ijtag_ce = ijtag_ce;
