...
Module msrv_soc_system_controllerwrapper_sys_controller_tessent_occ {
   ...
   Instance tdr_sib Of msrv_soc_system_controllerwrapper_sys_controller_tessent_occ_sib_int {
   ...
   Attribute tessent_instrument_container = "msrv_soc_system_controllerwrapper_sys_controller_occ.instrument";
